...
project_home = user_home + '/project/myproject' # you may need to change the working directory to match your project
...
# A more complete+correct solution of creating a systemd service our of your executable...
#execute "systemctl daemon-reload" do
#  action :nothing
#end
#cookbook_file "/etc/systemd/system/hello.service" do  # this installs files/hello.service as a service description
#  notifies :run, 'execute[systemctl daemon-reload]'
#end
#execute "systemctl enable hello" do
